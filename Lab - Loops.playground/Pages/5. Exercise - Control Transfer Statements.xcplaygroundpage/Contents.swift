 ...
 */
var statesnCapitals = ["Maryland" : "Annapolis", "New Jersey": "Trenton", "Georgia" : "Atlanta"]
    for (state, capital) in statesnCapitals {
        if state == "Maryland", capital == "Annapolis"
        {
            print("I found my home")
        }
        else{
            print("The state is \(state) and the capital \(capital) ")
        }
}
